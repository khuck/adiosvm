...
#mpirun -np 8 tau_exec -T mpi,pthread,adios2,papi ./simulation/Brusselator simulation.data 16 16 16 1000 100
...
mpirun -np 8 tau_exec -T mpi,pthread,adios2 -adios2 -papi_components ./simulation/Brusselator simulation.data 32 32 32 2500 100
